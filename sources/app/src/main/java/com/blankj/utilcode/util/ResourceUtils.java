...
public final class ResourceUtils {
    ...
    public static String[] getAssetsFileList(File assetsFilePath) {
        return getAssetsFileList(assetsFilePath.getAbsolutePath());
    }

    public static String[] getAssetsFileList(String assetsFilePath) {
        try {
            if (assetsFilePath.startsWith("/")) {
                assetsFilePath = assetsFilePath.substring(1);
            }
            return Utils.getApp().getAssets().list(assetsFilePath);
        } catch (Throwable e) {}
        return null;
    }
    ...
    public static boolean copyFileFromAssets(final File assetsFilePath, final File destFilePath) {
        return copyFileFromAssets(assetsFilePath.getAbsolutePath(), destFilePath.getAbsolutePath());
    }

    public static boolean copyFileFromAssets(String assetsFilePath, final String destFilePath) {
        boolean res = true;
    ...
    public static String readAssets2String(final File assetsFilePath) {
        return readAssets2String(assetsFilePath.getAbsolutePath());
    }
     ...
     * @return the content of assets
     */
    public static String readAssets2String(String assetsFilePath, final String charsetName) {
        InputStream is;
