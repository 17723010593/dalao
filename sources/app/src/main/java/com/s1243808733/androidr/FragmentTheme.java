...
public class FragmentTheme extends BaseRFragment {
	...
	public BaseRBaseAdapter onCreateAdapter(Bundle savedInstanceState) throws IllegalArgumentException, IllegalAccessException {
		...
		return new AdapterStyle(getActivity(), list);
	}
	...
	public class AdapterStyle extends BaseRBaseAdapter {
		...
		public AdapterStyle(Context ctx, List<BaseRItem> list) {
			this.list = list;
