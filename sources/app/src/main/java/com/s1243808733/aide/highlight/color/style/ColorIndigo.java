...
public class ColorIndigo extends ColorImpl {
    ...
    new Colors("Keyword", "关键词颜色", "#FFFF5A5A", "#FFFF6060");

    public static final Colors IDENTIFIER=
    new Colors("Identifier", "标识符颜色", "#FF000000", "#FFF0BE4B");

    public static final Colors LITERAL=
    new Colors("Literal", "字符串、数字、布尔值颜色",  "#FFE91E63", "#FF8BC34A");

    public static final Colors OPERATOR=
    new Colors("Operator", "操作符颜色",  "#FF03A9F4", "#FFF0BE4B");

    public static final Colors TYPE_IDENTIFIER=
    new Colors("Type Identifier", "类型标识符颜色", "#FF0096FF", "#FF4FC3F7");

    public static final Colors NAMESPACE_IDENTIFIER=
    new Colors("Namespace/Package Identifier", "包名颜色", "#FF757575", "#FFF0BE4B");

    public static final Colors SEPARATOR=
    new Colors("Separator/Punctuator", "括号、标点颜色", "#FF0096FF", "#FF4FC3F7");
    ...
    new Colors("line number", "行号颜色", "#FFBDBDBD", "#FF4FC3F7");
    ...
    new Colors("selected background", "已选文字背景颜色", "#FFABABAB", "#CCFF408E");
