...
/* package */public final class StringFogMappingPrinter {
    ...
    /* package */public StringFogMappingPrinter(File mappingFile) {
        this.mMappingFile = mappingFile;
    }

    /* package */public void startMappingOutput() {
        try {
    ...
    /* package */public void ouputInfo(String key, String implementation) {
        try {
    ...
    /* package */public void output(String className, String originValue, String encryptValue) {
    ...
    /* package */public void endMappingOutput() {
        if (mWriter != null) {
			try {
				mWriter.close();
			} catch (IOException e) {}
