...
ColorPickerDialog.OnColorChangedListener {
    ...
    protected void onSetInitialValue(boolean restoreValue, Object defaultValue) {
        ...
        int color=0;
        if (restoreValue) {
            color = getPersistedInt(mValue) ;
        } else {
            try {
                String str=getSharedPreferences().getString(getKey(), null);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            mAlphaSliderEnabled = attrs.getAttributeBooleanValue(null, "alphaSlider", mAlphaSliderEnabled);
            mHexValueEnabled = attrs.getAttributeBooleanValue(null, "hexValue", mHexValueEnabled);
        }
    }
    ...
    public void onColorChanged(int color) {
		...
		.putString(getKey(), convertToARGB(color)).commit();
    ...
    protected void showDialog(Bundle state) {
        ...
        mDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "默认", new DialogInterface.OnClickListener(){
