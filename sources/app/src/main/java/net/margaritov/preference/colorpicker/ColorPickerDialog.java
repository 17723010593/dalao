...
View.OnClickListener, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private void init(int color) {
        ...
        setButton(BUTTON_POSITIVE, getContext().getString(android.R.string.ok), new DialogInterface.OnClickListener(){
        ...
        setButton(BUTTON_NEGATIVE, getContext().getString(android.R.string.cancel), new DialogInterface.OnClickListener(){
	...
	private boolean ismHexValSet=false;
